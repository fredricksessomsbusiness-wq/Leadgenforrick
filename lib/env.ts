...
export const env = {
  ...
  dataforseoLogin: firstDefined('DATAFORSEO_LOGIN'),
  dataforseoPassword: firstDefined('DATAFORSEO_PASSWORD'),
  dataforseoLocationCode: Number(firstDefined('DATAFORSEO_LOCATION_CODE') || '2840'),
